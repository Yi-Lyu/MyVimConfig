...
function! s:Tlist_Window_Display_Help()
    ...
    if s:tlist_brief_help
        " Add the brief help
        call append(0, '" Press <F4> to display help text')
    else
        ...
        call append(15, '" <F4> : Remove help text')
    endif
endfunction
...
function! s:Tlist_Window_Init()
    ...
    nnoremap <buffer> <silent> <F4> :call <SID>Tlist_Window_Toggle_Help_Text()<CR>
    ...
    inoremap <buffer> <silent> <F4>  <C-o>:call <SID>Tlist_Window_Toggle_Help_Text()<CR>
